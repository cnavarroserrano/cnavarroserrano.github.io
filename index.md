...
<p class="paper-row"
   style="margin:1px 0 0; color: var(--bs-link-color); white-space: nowrap;">
  <a class="paper" href="papers/WP_RCT_homelessness.pdf" target="_blank" rel="noopener noreferrer">
    <i class="fa-solid fa-file" aria-hidden="true"></i>Draft
  </a>
  <span>&nbsp;|&nbsp;</span>
  <details class="abs" style="display:inline-block; vertical-align:baseline;">
    <summary><a><span>Abstract</span></a></summary>
    <div style="display:block; margin-top:10px; white-space: normal;">
